...
A CLI tool that checks whether every entry in your **reference list** is cited somewhere in your paper, and conversely, whether every **in-text citation** in the paper actually has a corresponding reference — all instantly without LLM-wrapper slop.
